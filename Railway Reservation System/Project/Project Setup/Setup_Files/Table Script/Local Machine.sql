...
-- Migrated Schemata: Railway
-- Source Schemata: Railway
...
-- Table Railway.day1
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `Railway`.`day1` (
...
-- Table Railway.day2
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `Railway`.`day2` (
  `Class` VARCHAR(45) NOT NULL,
  `Intercity` INT NULL DEFAULT NULL,
  `Vindhyachal_Exp` INT NULL DEFAULT NULL,
  `Shatabdi_Exp` INT NULL DEFAULT NULL,
...
-- Table Railway.day3
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `Railway`.`day3` (
  `Class` VARCHAR(45) NOT NULL,
  `Intercity` INT NULL DEFAULT NULL,
  `Vindhyachal_Exp` INT NULL DEFAULT NULL,
  `Shatabdi_Exp` INT NULL DEFAULT NULL,
...
-- Table Railway.day4
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `Railway`.`day4` (
  `Class` VARCHAR(45) NOT NULL,
  `Intercity` INT NULL DEFAULT NULL,
  `Vindhyachal_Exp` INT NULL DEFAULT NULL,
  `Shatabdi_Exp` INT NULL DEFAULT NULL,
...
-- Table Railway.day5
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `Railway`.`day5` (
  `Class` VARCHAR(45) NOT NULL,
  `Intercity` INT NULL DEFAULT NULL,
  `Vindhyachal_Exp` INT NULL DEFAULT NULL,
  `Shatabdi_Exp` INT NULL DEFAULT NULL,
...
-- Table Railway.day6
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `Railway`.`day6` (
  `Class` VARCHAR(45) NOT NULL,
  `Intercity` INT NULL DEFAULT NULL,
  `Vindhyachal_Exp` INT NULL DEFAULT NULL,
  `Shatabdi_Exp` INT NULL DEFAULT NULL,
...
-- Table Railway.day7
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `Railway`.`day7` (
  `Class` VARCHAR(45) NOT NULL,
  `Intercity` INT NULL DEFAULT NULL,
  `Vindhyachal_Exp` INT NULL DEFAULT NULL,
  `Shatabdi_Exp` INT NULL DEFAULT NULL,
...
-- ----------------------------------------------------------------------------
-- Table Railway.seat_price
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `Railway`.`seat_price` (
  `Class` VARCHAR(45) NOT NULL,
  `Price` INT NULL DEFAULT NULL,
  PRIMARY KEY (`Class`));
